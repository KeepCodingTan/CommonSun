 ...
 */
public abstract class AbsListFragment<T,DB extends ViewDataBinding, VM extends BaseListViewModel<T>> extends BaseActivity<DB,VM> implements ListPageListener<T> {

    public RecyclerView recyclerView = getRecycleView();
